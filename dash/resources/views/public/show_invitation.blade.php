            ...
            <div class="text-center pt-4">
                ...
                <div class="py-4">
                    <div class="img-crop border border-3 border-light shadow mx-auto">
                        <img src="{{ asset('storage/' . $photosByCategory['photo couple']) }}" alt="bg" onclick="util.modal(this)">
                    </div>
                </div>
